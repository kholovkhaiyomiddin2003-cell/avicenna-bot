...
#   Медицинский факультет — Факултети тиббӣ
...
bot = telebot.TeleBot(8711747881:AAG8gtDfsguqxlnl6y9R5A_fWUPY4fR_5o4)

# ==============================================
#   ЯЗЫК ПОЛЬЗОВАТЕЛЕЙ (хранится в памяти)
# ==============================================

user_lang = {}  # {user_id: "ru" или "tj"}
...
LANG = {
    "ru": {
        ...
        "choose_lang": "Выбери язык / Забонро интихоб кунед 🌐",
...
# ==============================================
#   БАЗА МАТЕРИАЛОВ (русские названия)
#   Таджикские названия ниже в SUBJECTS_TJ
# ==============================================
...
# ==============================================
#   ССЫЛКИ НА МАТЕРИАЛЫ
#   Замени "https://t.me/avicenna_files" на
#   реальные ссылки своего канала
# ==============================================
...
LINKS = {
    "1": [
        ...
        [
            ...
            ("📋 Термины + рецептура",         "https://t.me/avicenna_files"),
        ],
    ],
    "2": [
        [
...
def show_course(call):
    ...
    lang = get_lang(call.from_user.id)
    L = LANG[lang]
    course_name = L["course_names"][course_id]
    bot.edit_message_text(
        f"{course_name}\n\n{L['choose_subject']}",
        call.message.chat.id,
        call.message.message_id,
